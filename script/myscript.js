...
function karim() {
	window.history.pushState('DahabContact', 'Contact', 'DahabContact.html');
	//history.pushState({}, "", "DahabContact.html")
	// window.history.pushState({page: "another"}, "Contact", "DahabContact.html");
	//history.pushState({}, null, file:///D:/dahab/DahabContact.html);
/*	
	const state = { 'page_id': 1, 'user_id': 5 }
const title = 'Contact'
const url = 'DahabContact.html'
...
history.pushState(state, title, url)
	...
	window.history.pushState('DahabContact.html', 'Contact', '/DahabContact.html');
	history.pushState({}, null, 'DahabContact.html');
window.history.pushState('', 'Contact', 'DahabContact.html'); */
//}
